...
const (
	AgentControl_Connect_FullMethodName = "/le0x.v1.AgentControl/Connect"
)
...
func (c *agentControlClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AgentMessage, ControllerMessage], error) {
...
type AgentControl_ConnectClient = grpc.BidiStreamingClient[AgentMessage, ControllerMessage]
...
func (UnimplementedAgentControlServer) Connect(grpc.BidiStreamingServer[AgentMessage, ControllerMessage]) error {
...
func _AgentControl_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AgentControlServer).Connect(&grpc.GenericServerStream[AgentMessage, ControllerMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentControl_ConnectServer = grpc.BidiStreamingServer[AgentMessage, ControllerMessage]
...
var AgentControl_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "le0x.v1.AgentControl",
	...
	Metadata: "proto/le0x/v1/agent_control.proto",
}
